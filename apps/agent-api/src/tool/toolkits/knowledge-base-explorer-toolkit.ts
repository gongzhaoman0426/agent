...
export class KnowledgeBaseExplorerToolkit extends BaseToolkit {
  ...
  protected async initTools(): Promise<void> {
    ...
    this.tools = [
      FunctionTool.from(this.listAllKnowledgeBases.bind(this), {
      ...
      FunctionTool.from(this.checkKnowledgeBaseDetail.bind(this), {
  ...
  async listAllKnowledgeBases(): Promise<string> {
    try {
  ...
  async checkKnowledgeBaseDetail(params: { knowledgeBaseId: string }): Promise<string> {
    try {
